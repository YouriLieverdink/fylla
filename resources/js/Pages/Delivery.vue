        ...
        <div class="mb-8 flex items-center gap-6">
            <div class="flex-[7]">
                ...
                <p class="max-w-[62ch] text-[15px] leading-[1.55] text-muted">
                    ...
                    your own, billable and non-billable, against each client's monthly target. Assign projects
                    and flag billable inline; targets are edited on each client's own page.
                </p>
            </div>
